...
fun getRecipes(context: Context): Array<Recipe>
{
    ...
    var recipe1 = Recipe("Mojito", "Delicious mint & lime",
        arrayListOf("Lime", "Sugar", "White rum", "Mint leaves", "Soda water"), listOfColors[0] ,R.drawable.coctail)
    var recipe2 = Recipe("Old fashioned", "Classic and classy",
        arrayListOf("Sugar", "Angostura bitters", "Water", "Bourbon", "Orange peel"),listOfColors[1], R.drawable.coctail)
